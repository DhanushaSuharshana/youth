...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Arrange Testimonial | Youth Service LTD</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Arrange Testimonial</h4>
                                        <form id="form-data"> 
                                            <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                                ...
                                                foreach ($COMMENT->all() as $key => $comment) {
                                                    ...
                                                    <li class="col-md-6 col-xl-3"  >
                                                        ...
                                                        <div class="card">
                                                            <img class="card-img-top img-fluid" src="../upload/comments/<?php echo $comment['image_name'] ?>" alt="<?php echo $event['title'] ?>">
                                                            <input type="hidden" name="sort[]"  value="<?php echo $comment["id"]; ?>" class="sort-input"/> 
                                                        </div>
                                                    </li> 
                                                <?php } ?>
                                            </ul>

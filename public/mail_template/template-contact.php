<?php
function mail_set_template($content = [])
{
    //$data['aaaa']='aaa';
													...
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														...
														<tr>
															<td class='text pb20'
																...
																<h4>Mr/Mrs ".$content["name"].",</h4>
                                                                <p style='color:#000; '>Thank you very much for contacting us.</p><br>
                                                                <p style='color:#000; '>Your Message received as subject to ".$content["subject"].".</p><br>
										...
										<table width='100%' border='0' cellspacing='0' cellpadding='0'>
											...
											<tr>
												<td class='text-footer1 pb10'
													...
													Powered by Youth Services LTD - Software Development Team</td>
											</tr>

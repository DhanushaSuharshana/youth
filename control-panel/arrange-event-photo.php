...
<head>
    ...
    <meta charset="utf-8" />
    <title>Arrange Event Photo | Youth Service LTD</title>
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage Event Photo</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Arrange Event Photo</h4>
                                    <form id="form-data">
                                        <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                            <?php
                                            $EVENT_PHOTO = new EventPhoto(NULL);
                                            foreach ($EVENT_PHOTO->getEventPhotosById($id) as $key => $event) {
                                            ?>
                                                <li class="col-md-6 col-xl-3">
                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="../upload/event/gallery/thumb/<?php echo $event['image_name'] ?>" alt="<?php echo $event['caption'] ?>">

...
<body class="someBlock">
    ...
    ?>
        <!--  Large modal example -->
        <div class="modal fade bs-example-modal-lg-<?php echo $album_photo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myLargeModalLabel">Edit Details : <?php echo $album_photo['caption']; ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" id="form-data-<?php echo $album_photo['id']; ?>" class="from">
                            <div class="card-body">

                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Caption</label>
                                    <div class="col-md-10">
                                        <input class="form-control caption" type="text" name="caption" placeholder="Enter Caption" value="<?php echo $album_photo['caption'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control image_name" type="file" name="image_name" value="<?php echo $album_photo['image_name']; ?>">
                                        <img width="200" class="img-responsive" src="../upload/photo-album/gallery/thumb/<?php echo $album_photo['image_name']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12" style="display: flex; justify-content: flex-end;margin-top: 15px;">
                                        <button class="btn btn-primary edit-data" dataId="<?php echo $album_photo['id']; ?>" type="submit">Update</button>
                                    </div>
                                </div>
                            </div>
                        </form>

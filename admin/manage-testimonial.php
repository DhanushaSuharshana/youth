                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        foreach ($COMMENT->all() as $comment) {
                                            ?>
                                            <div class="col-md-6 col-xl-3" id="div<?php echo $comment['id'] ?>">
                                                <!-- Simple card -->
                                                <div class="card">
                            ...
                            <form method="POST" id="form-data-<?php echo $comment['id']; ?>" class="from">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-url-input" class="col-md-2 col-form-label">Date</label>
                                        <div class="col-md-10">
                                            <input class="form-control date_edit" type="text" name="date" value="<?php echo $comment['date'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-url-input" class="col-md-2 col-form-label">Active / Inactive</label>
                                        <div class="col-md-10 mt-2">
                                            <input class="form-check-input" type="checkbox" id="is_active<?php echo $comment['id']; ?>" name="active" value="1" <?= ($comment['is_active']) ? "checked='checked'" : ''; ?>>
                                            <label class="form-check-label text-danger" for="is_active<?php echo $comment['id']; ?>">
                                                Active / Inactive
                                            </label>
                                        </div>
                                    </div>

...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Arrange Photo Album | Youth Service LTD</title>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Manage Photo Album</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Arrange Photo Album</h4>
                                        <form id="form-data"> 
                                            <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                                <?php
                                                $ALBUM_PHOTO = new AlbumPhoto(NULL);
                                                foreach ($ALBUM_PHOTO->getAlbumPhotosById($id) as $key => $album_photo) {
                                                    ?> 
                                                    <li class="col-md-6 col-xl-3"  >
                                                        <span class="number-class">(<?php echo $key + 1; ?>)</span> 
                                                        <div class="card">
                                                            <img class="card-img-top img-fluid" src="../upload/photo-album/gallery/thumb/<?php echo $album_photo['image_name'] ?>" alt="<?php echo $album_photo['title'] ?>">
                                                            <input type="hidden" name="sort[]"  value="<?php echo $album_photo["id"]; ?>" class="sort-input"/> 
                                                        </div>

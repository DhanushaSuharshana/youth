...
<head>
    ...
    <meta charset="utf-8" />
    <title>Arrange News Photo | Youth Service LTD</title>
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage News Photo</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Arrange News Photo</h4>
                                    <form id="form-data">
                                        <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                            <?php
                                            $NEWS_PHOTO = new NewsPhoto(NULL);
                                            foreach ($NEWS_PHOTO->getNewsPhotosById($id) as $key => $news) {
                                            ?>
                                                <li class="col-md-6 col-xl-3">
                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="../upload/news/gallery/thumb/<?php echo $news['image_name'] ?>" alt="<?php echo $news['caption'] ?>">

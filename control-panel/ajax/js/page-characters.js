...
//---------- Start Create Data ---------
    $("#create").click(function (event) {
        ...
        if (!$('#name').val() || $('#name').val().length === 0) {
        ...
        } else if (!$('#designation').val() || $('#designation').val().length === 0) {
            swal({
                title: "Error!",
                text: "Please enter designations..!",
                type: 'error',
                timer: 1500,
                showConfirmButton: false
            });
            ...
            //-- ** End Error Messages
        } else if (!$('#facebook').val() || $('#facebook').val().length === 0) {
            swal({
                title: "Error!",
            ...
            $.ajax({
                url: "ajax/php/page-characters.php",
                type: "POST",
                data: formData,
                async: false,
                dataType: 'json',

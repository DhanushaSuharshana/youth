...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Manage Courses | Youth Service LTD</title>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="form-data-<?php echo $course['id']; ?>">
                            <div class="card-body">                                
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text"   id="name" name="name" placeholder="Enter News Title" value="<?php echo $course['name'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-search-input" class="col-md-2 col-form-label">Max Students</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" id="max_student" name="max_student" placeholder="Please enter max students in one course" value="<?php echo $course['max_student'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text"   id="level" name="level"  value="<?php echo $course['level'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-url-input" class="col-md-2 col-form-label">Languages</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text"   id="languages" name="languages"  value="<?php echo $course['languages'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-url-input" class="col-md-2 col-form-label">Duration</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text"  id="duration" name="duration"  value="<?php echo $course['duration'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-url-input" class="col-md-2 col-form-label">Start Date</label>
                                    <div class="col-md-10">
                                        <input class="form-control start_date" type="text" id="start_date" name="start_date" value="<?php echo $course['start_date'] ?>">
                                    </div>
                                </div> 
                                <div class="mb-3 row">
                                    <label for="example-url-input" class="col-md-2 col-form-label">Short Description</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" id="short_description" name="short_description" value="<?php echo $course['short_description'] ?>">
                                    </div>
                                </div> 
                                <div class="mb-3 row">
                                    <label for="example-url-input" class="col-md-2 col-form-label">Description</label>
                                    <div class="col-md-10">
                                        <textarea class="description" name="description"><?php echo $course['description']; ?></textarea>
                                    </div>
                                </div> 

                                <div class="row">
                                    <div class="col-12" style="display: flex; justify-content: flex-end;margin-top: 15px;">
                                        <input class="form-control id" type="hidden" value="<?php echo $course['id']; ?>">

...
<head>
    ...
    <meta charset="utf-8" />
    <title>Create Advertisement | Youth Service</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Create your Advertisement Post.</h4>
                                    <form id="form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" id="url" name="url" placeholder="Enter Advertisement URL">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Title</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" id="title" name="title" placeholder="Enter Advertisement Title">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" id="date" name="date" placeholder="Enter Advertisement Date">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">

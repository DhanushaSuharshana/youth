...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Arrange Leaders | Youth Service LTD</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Arrange Leaders</h4>
                                        <form id="form-data"> 
                                            <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                                <?php
                                                $LEADERS = new Leaders(NULL);
                                                foreach ($LEADERS->all() as $key => $leaders) {
                                                    ?> 
                                                    <li class="col-md-6 col-xl-3"  >
                                                        <span class="number-class">(<?php echo $key + 1; ?>)</span> 
                                                        <div class="card">
                                                            <img class="card-img-top img-fluid" src="../upload/leader/<?php echo $leaders['image_name'] ?>" alt="<?php echo $event['title'] ?>">
                                                            <input type="hidden" name="sort[]"  value="<?php echo $leaders["id"]; ?>" class="sort-input"/> 
                                                        </div>

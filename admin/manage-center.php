                                    ...
                                    <form method="POST" id="form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" readonly="true" type="text"  id="type" name="type" value="1">
                                                </div>
                                            </div>
                            ...
                            <form method="POST" id="form-data-<?php echo $center['id']; ?>">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-search-input" class="col-md-2 col-form-label">Type</label>
                                        <div class="col-md-10">
                                            <input class="form-control type" readonly="true" type="text" name="type" value="<?php echo $center['type']; ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-md-2 col-form-label">District</label>

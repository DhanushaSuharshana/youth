...
<head>
    ...
    <meta charset="utf-8" />
    <title>Create News Photo | <?php echo $PAGE_NEWS->title ?> | Youth Service LTD</title>
...
<body class="someBlock">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Create Page News Photo</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                        <li class="breadcrumb-item active">Create Page News Photo</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Create News Photo - " <?php echo $PAGE_NEWS->title ?> "</h4>
                                    <form id="form-data">
                                        <div class="mb-3 row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        foreach ($PAGE_NEWS_PHOTO->getNewsPhotosById($id) as $news_photo) {
                                        ?>
                                            <div class="col-md-6 col-xl-3" id="div<?php echo $news_photo['id'] ?>">
                                                <div class="card">
                                                    <img class="card-img-top img-fluid" src="../upload/page/news/gallery/thumb/<?php echo $news_photo['image_name'] ?>" alt="<?php echo $news_photo['caption'] ?>">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="arrange-page-news-photo.php?id=<?php echo $id; ?>" class="badge bg-pill bg-soft-primary font-size-14"><i class="fas fa-exchange-alt  p-1"></i></a> |
    ...
    <?php
    foreach ($PAGE_NEWS_PHOTO->all()  as $news_photo) {
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <img width="200" class="img-responsive" src="../upload/page/news/gallery/thumb/<?php echo $news_photo['image_name']; ?>">
                                    </div>
                                </div>
    ...
    <!-- js -->
    <script src="ajax/js/page-news-photo.js" type="text/javascript"></script>

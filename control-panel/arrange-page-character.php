...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Arrange Page Characters | Youth Service LTD</title>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Manage Characters</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Arrange Characters</h4>
                                        <form id="form-data"> 
                                            <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                                <?php
                                                $PAGES_CHARACTERS = new PageCharacter(NULL);
                                                foreach ($PAGES_CHARACTERS->getPageCharactersById($PAGES->id) as $key => $page_character) {
                                                    ?> 
                                                    <li class="col-md-6 col-xl-3"  >
                                                        <span class="number-class">(<?php echo $key + 1; ?>)</span> 
                                                        <div class="card">
                                                            <img class="card-img-top img-fluid" src="../upload/page/character/<?php echo $page_character['image_name'] ?>" alt="<?php echo $page_character['name'] ?>">
                                                            <input type="hidden" name="sort[]"  value="<?php echo $page_character["id"]; ?>" class="sort-input"/> 
                                                        </div>

...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        buildItem: function (type, page) {
            ...
            $itemContent.addClass(this.options[type + 'Class']);
            $itemContent.data('page', page);
            $itemContent.data('page-type', type);
            $itemContent.attr('href', this.makeHref(page)).addClass(this.options.anchorClass).html(itemText);

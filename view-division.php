...
<body>
    ...
    <section class="team-area pb-70">
        <div class="container">
            ...
            <div class="team-slides owl-carousel owl-theme owl-loaded owl-drag">
                <div class="owl-stage-outer">
                    <div class="row owl-stage" style="transform: translate3d(-382px, 0px, 0px); transition: all 0.25s ease 0s; width: 1528px;">
                        ...
                        <div class="col-lg-3 col-md-3 col-xs-12">
                            <div class=" owl-item active" style="width: 352px; margin-right: 30px;">
                                <div class="single-instructor-box mb-30">
                                    <div class="image">
                                    ...
                                    <div class="content">
                                        <h3><a href="single-instructor.html">Lee Munroe</a></h3>
            ...
            <div id="particles-js-circle-bubble-3"><canvas class="particles-js-canvas-el" style="width: 100%; height: 100%;" width="1353" height="748"></canvas></div>
    </section>

                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="form-data"> 
                                            <ul class="row mt-3 arrange-container" id="sortable" style="list-style-type: none; ">
                                                ...
                                                foreach ($ALBUM_VIDEO->getAlbumVideosById($id) as $key => $album_video) {
                                                    ?> 
                                                    <li class="col-md-6 col-xl-3"  >
                                                        <span class="number-class">(<?php echo $key + 1; ?>)</span> 
                                                        <div class="card">
                                                            <img class="card-img-top img-fluid" src="../upload/video-album/gallery/thumb/<?php echo $album_video['image_name'] ?>" alt="<?php echo $album_video['title'] ?>">
